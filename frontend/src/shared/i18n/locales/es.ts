...
export const es: Catalogue = {
  ...
  'stock.cost': 'Coste de adquisición',
  'stock.costUnknown': 'sin registrar',
  'stock.reconditioning': 'Reacondicionamiento',
  'stock.reconditioningNone': 'todavía ninguno',
  'stock.bookValue': 'Total invertido en el coche',
  ...
  'connectors.loading': 'Cargando el borde de integración…',
  'connectors.denied': 'No tiene acceso a las integraciones de este concesionario.',
  'connectors.shipped': 'A qué se conecta esta versión',
  'connectors.none': 'Esta versión no incluye ningún conector.',
  'connectors.reads': 'Lee',
  'connectors.limitations': 'Limitaciones conocidas',
  'connectors.heldBack': 'Registros retenidos',
  'connectors.nothingHeld': 'No hay nada retenido.',
  'connectors.heldNote': 'Llegaron y no se pudieron aplicar. Reintentar ejecuta el registro de verdad; si sigue sin encajar, permanece aquí con el nuevo motivo. Los valores recibidos no se muestran: son datos personales de alguien y permanecen en el servidor.',
  'connectors.colRecord': 'Registro',
  'connectors.colWhy': 'Por qué se retuvo',
  'connectors.colHeldSince': 'Retenido desde',
  'connectors.colUntil': 'Conservado hasta',
  'connectors.colActions': 'Qué hacer',
  'connectors.replay': 'Intentarlo de nuevo',
  'connectors.replaying': 'Ejecutando…',
  'connectors.dismiss': 'Nunca se aplicará',
  'connectors.dismissAsk': '¿Por qué {id} nunca se aplicará?',
  'connectors.dismissed': 'Se marcó {id} como que nunca se aplicará.',
  'connectors.replayApplied': '{id} se aplicó esta vez y ha salido de la cola.',
  'connectors.replayRefused': '{id} fue rechazado de nuevo: {reason}',
  'connectors.certification.FixtureTested': 'Probado con datos simulados',
  'connectors.certification.SandboxCertified': 'Certificado en entorno de pruebas',
  'connectors.certification.ProductionCertified': 'Certificado en producción',
  'connectors.certification.Experimental': 'Experimental',
  'connectors.certificationMeans.FixtureTested': 'Solo pruebas automatizadas. No es una garantía de que funcione con un proveedor real.',
  'connectors.certificationMeans.SandboxCertified': 'Superó el entorno de pruebas del proveedor y las pruebas de fallo y reintento.',
  'connectors.certificationMeans.ProductionCertified': 'Completó una comparación en paralelo y una conciliación aprobadas por el concesionario.',
  'connectors.certificationMeans.Experimental': 'Comunitario o experimental. Lea las limitaciones antes de confiar en él.',
  ...
  'customers.addAddress': 'Añadir dirección',
  'customers.editAddress': 'Editar',
  'customers.removeAddress': 'Quitar la dirección',
  'customers.addressLine1': 'Dirección, línea 1',
  'customers.addressLine2': 'Dirección, línea 2',
  'customers.addressCity': 'Ciudad',
  'customers.addressArea': 'Estado o región',
  'customers.addressCounty': 'Condado',
  'customers.addressPostalCode': 'Código postal',
  'customers.addressCountry': 'País',
  ...
  'deals.registrationAddress': 'Dirección de matriculación',
  'deals.registrationAddressLede':
    'Dónde se matriculará o guardará este coche. No siempre coincide con el domicilio del cliente.',
  'deals.regLine1': 'Dirección, línea 1',
  'deals.regLine2': 'Dirección, línea 2',
  'deals.regCity': 'Ciudad',
  'deals.regArea': 'Estado o región',
  'deals.regCounty': 'Condado',
  'deals.regPostalCode': 'Código postal',
  'deals.regCountry': 'País',
  'deals.regSave': 'Guardar la dirección',
  'deals.regClear': 'Borrar la dirección',
