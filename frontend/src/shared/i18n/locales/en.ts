...
export const en = {
  ...
  'stock.reconditioning': 'Reconditioning',
  'stock.reconditioningNone': 'none yet',
  'stock.bookValue': 'Total in the car',
  ...
  'connectors.loading': 'Loading the integration edge…',
  'connectors.denied': 'You do not have access to this dealership’s integrations.',
  'connectors.shipped': 'What this build connects to',
  'connectors.none': 'This build ships no connectors.',
  'connectors.reads': 'Reads',
  'connectors.limitations': 'Known limitations',
  'connectors.heldBack': 'Records held back',
  'connectors.nothingHeld': 'Nothing is being held back.',
  'connectors.heldNote': 'These arrived and could not be applied. Replaying runs the record again for real; if it still does not fit, it stays here with the new reason. The values that arrived are not shown — they are somebody’s personal details, and they stay on the server.',
  'connectors.colRecord': 'Record',
  'connectors.colWhy': 'Why it was held',
  'connectors.colHeldSince': 'Held since',
  'connectors.colUntil': 'Kept until',
  'connectors.colActions': 'What to do',
  'connectors.replay': 'Run it again',
  'connectors.replaying': 'Running…',
  'connectors.dismiss': 'It will never apply',
  'connectors.dismissAsk': 'Why will {id} never apply?',
  'connectors.dismissed': '{id} was marked as never going to apply.',
  'connectors.replayApplied': '{id} applied this time, and has left the queue.',
  'connectors.replayRefused': '{id} was refused again: {reason}',
  'connectors.certification.FixtureTested': 'Fixture tested',
  'connectors.certification.SandboxCertified': 'Sandbox certified',
  'connectors.certification.ProductionCertified': 'Production certified',
  'connectors.certification.Experimental': 'Experimental',
  'connectors.certificationMeans.FixtureTested': 'Automated tests only. This is not a promise that it works against a real provider.',
  'connectors.certificationMeans.SandboxCertified': 'Passed the vendor’s sandbox and the failure and replay tests.',
  'connectors.certificationMeans.ProductionCertified': 'Completed a dealer-approved shadow comparison and reconciliation.',
  'connectors.certificationMeans.Experimental': 'Community or experimental. Read the limitations below before relying on it.',
