...
export const de: Catalogue = {
  ...
  'nav.groupSales': 'Verkauf',
  'nav.groupService': 'Werkstatt',
  'nav.groupAccounting': 'Buchhaltung',
  'nav.groupPeople': 'Personal & Sicherheit',
  ...
  'enum.chargeKind.DocumentationFee': 'Bearbeitungsgebühr',
  ...
  'stock.reconditioning': 'Aufbereitung',
  'stock.reconditioningNone': 'noch keine',
  'stock.bookValue': 'Gesamt im Fahrzeug',
  ...
  'connectors.loading': 'Integrationen werden geladen…',
  'connectors.denied': 'Sie haben keinen Zugriff auf die Integrationen dieses Autohauses.',
  'connectors.shipped': 'Womit sich diese Version verbindet',
  'connectors.none': 'Diese Version liefert keine Konnektoren aus.',
  'connectors.reads': 'Liest',
  'connectors.limitations': 'Bekannte Einschränkungen',
  'connectors.heldBack': 'Zurückgehaltene Datensätze',
  'connectors.nothingHeld': 'Es wird nichts zurückgehalten.',
  'connectors.heldNote': 'Sie sind eingegangen und konnten nicht übernommen werden. Ein erneuter Versuch führt den Datensatz wirklich aus; passt er weiterhin nicht, bleibt er mit dem neuen Grund hier. Die eingegangenen Werte werden nicht angezeigt — es sind personenbezogene Daten und sie bleiben auf dem Server.',
  'connectors.colRecord': 'Datensatz',
  'connectors.colWhy': 'Grund',
  'connectors.colHeldSince': 'Zurückgehalten seit',
  'connectors.colUntil': 'Aufbewahrt bis',
  'connectors.colActions': 'Was zu tun ist',
  'connectors.replay': 'Erneut ausführen',
  'connectors.replaying': 'Wird ausgeführt…',
  'connectors.dismiss': 'Wird nie passen',
  'connectors.dismissAsk': 'Warum wird {id} nie übernommen werden können?',
  'connectors.dismissed': '{id} wurde als dauerhaft nicht übernehmbar markiert.',
  'connectors.replayApplied': '{id} wurde diesmal übernommen und hat die Warteschlange verlassen.',
  'connectors.replayRefused': '{id} wurde erneut abgelehnt: {reason}',
  'connectors.certification.FixtureTested': 'Mit Testdaten geprüft',
  'connectors.certification.SandboxCertified': 'In der Sandbox zertifiziert',
  'connectors.certification.ProductionCertified': 'Für den Produktivbetrieb zertifiziert',
  'connectors.certification.Experimental': 'Experimentell',
  'connectors.certificationMeans.FixtureTested': 'Nur automatisierte Tests. Das ist keine Zusage, dass es mit einem echten Anbieter funktioniert.',
  'connectors.certificationMeans.SandboxCertified': 'Hat die Sandbox des Anbieters sowie die Fehler- und Wiederholungstests bestanden.',
  'connectors.certificationMeans.ProductionCertified': 'Hat einen vom Autohaus freigegebenen Parallelvergleich samt Abstimmung abgeschlossen.',
  'connectors.certificationMeans.Experimental': 'Community oder experimentell. Lesen Sie die Einschränkungen, bevor Sie sich darauf verlassen.',
  ...
  'deals.lineTax': 'Steuer',
  'deals.taxWorkedOut': '{basis} zu {rate}',
  'deals.taxDisagrees': 'Das passt nicht zu {basis} zu {rate}, was {expected} ergibt.',
