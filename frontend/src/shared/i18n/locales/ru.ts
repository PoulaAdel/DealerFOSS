...
export const ru: Catalogue = {
  ...
  'record.opening': 'Открытие записи…',
  'record.unreachable':
    'Эту запись не удалось открыть. Возможно, она удалена или относится к той части бизнеса, которая вам недоступна.',
  'record.backToList': 'Назад к списку',
  ...
  'workshop.lineJob': 'Работа из каталога',
  ...
  'serviceSetup.denied': 'Вам недоступен цех.',
  'serviceSetup.backToWorkshop': 'Назад в цех',
  'serviceSetup.ratesTitle': 'Стоимость часа',
  'serviceSetup.ratesNote':
    'Задаётся для каждой площадки. Две площадки не обязаны брать одинаково, а гарантия возмещается по ставке производителя.',
  'serviceSetup.location': 'Площадка',
  'serviceSetup.chooseLocation': 'Выберите площадку…',
  'serviceSetup.perHour': 'За час',
  'serviceSetup.notSet': 'Не задано',
  'serviceSetup.setRate': 'Задать ставку',
  'serviceSetup.jobsTitle': 'Работы, которые продаёт цех',
  'serviceSetup.jobsNote':
    'Общие для всех площадок, как номер детали, чтобы одна и та же работа везде значила одно и то же.',
  'serviceSetup.code': 'Код',
  'serviceSetup.describes': 'Описание',
  'serviceSetup.standardHours': 'Нормативные часы',
  'serviceSetup.whoPays': 'Кто обычно платит',
  'serviceSetup.withdraw': 'Изъять',
  'serviceSetup.restore': 'Вернуть',
  'serviceSetup.addJob': 'Добавить работу',
  'serviceSetup.frozenNote':
    'Здесь ничего не удаляется. Изъятие убирает работу из предложения и оставляет верными все заказы, которые уже на неё ссылаются.',
  'workshop.hours': 'Часы',
