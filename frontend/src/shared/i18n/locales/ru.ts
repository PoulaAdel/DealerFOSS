...
export const ru: Catalogue = {
  ...
  'stock.reconditioning': 'Предпродажная подготовка',
  'stock.reconditioningNone': 'пока нет',
  'stock.bookValue': 'Всего вложено в автомобиль',
  ...
  'connectors.loading': 'Загрузка интеграций…',
  'connectors.denied': 'У вас нет доступа к интеграциям этого дилерского центра.',
  'connectors.shipped': 'С чем соединяется эта сборка',
  'connectors.none': 'В этой сборке нет коннекторов.',
  'connectors.reads': 'Читает',
  'connectors.limitations': 'Известные ограничения',
  'connectors.heldBack': 'Задержанные записи',
  'connectors.nothingHeld': 'Ничего не задержано.',
  'connectors.heldNote': 'Они поступили, но их не удалось применить. Повтор запускает запись по-настоящему; если она снова не подойдёт, то останется здесь с новой причиной. Поступившие значения не показываются — это чьи-то персональные данные, и они остаются на сервере.',
  'connectors.colRecord': 'Запись',
  'connectors.colWhy': 'Причина',
  'connectors.colHeldSince': 'Задержана с',
  'connectors.colUntil': 'Хранится до',
  'connectors.colActions': 'Что сделать',
  'connectors.replay': 'Повторить',
  'connectors.replaying': 'Выполняется…',
  'connectors.dismiss': 'Никогда не подойдёт',
  'connectors.dismissAsk': 'Почему {id} никогда не будет применена?',
  'connectors.dismissed': 'Запись {id} отмечена как та, что никогда не будет применена.',
  'connectors.replayApplied': '{id} применена и покинула очередь.',
  'connectors.replayRefused': '{id} снова отклонена: {reason}',
  'connectors.certification.FixtureTested': 'Проверено на тестовых данных',
  'connectors.certification.SandboxCertified': 'Сертифицировано в песочнице',
  'connectors.certification.ProductionCertified': 'Сертифицировано для эксплуатации',
  'connectors.certification.Experimental': 'Экспериментальный',
  'connectors.certificationMeans.FixtureTested': 'Только автоматические тесты. Это не обещание работы с реальным поставщиком.',
  'connectors.certificationMeans.SandboxCertified': 'Прошёл песочницу поставщика, а также тесты отказов и повторов.',
  'connectors.certificationMeans.ProductionCertified': 'Завершено параллельное сравнение и сверка, одобренные дилером.',
  'connectors.certificationMeans.Experimental': 'Сообщество или эксперимент. Прочитайте ограничения, прежде чем полагаться на него.',
  ...
  'workshop.payTypeReport': 'Отчёт по типу оплаты',
  'payType.title': 'Кто за что платил',
  'payType.from': 'С',
  'payType.to': 'По',
  'payType.loading': 'Подсчитываем цифры…',
  'payType.denied': 'У вас нет доступа к данным этой мастерской. Спросите менеджера, если это кажется ошибкой.',
  'payType.headlineCaption': 'Общая выручка за период.',
  'payType.totalRevenue': 'Общая выручка',
  'payType.tableCaption': 'Выручка по работе, запчастям и субподряду, по типу оплаты.',
  'payType.colPayer': 'Оплатил',
  'payType.colLabour': 'Работа',
  'payType.colParts': 'Запчасти',
  'payType.colSublet': 'Субподряд',
  'payType.colRevenue': 'Итого',
  'payType.colPartsCost': 'Себестоимость запчастей',
  'payType.colPartsGross': 'Маржа по запчастям',
  'payType.colOrders': 'Заказ-наряды',
  'payType.nothingInvoiced': 'За этот период ничего не выставлено, сверять нечего.',
  ...
  'nav.ageing': 'Кто нам должен',
  'nav.statements': 'Выписки',

  'ageing.title': 'Кто нам должен',
  'ageing.loading': 'Подсчитываем, кто сколько должен…',
  'ageing.denied': 'У вас нет доступа к этому.',
  'ageing.failed': 'Не удалось загрузить отчёт о задолженности.',
  'ageing.empty': 'Сейчас нам никто ничего не должен.',
  'ageing.colCustomer': 'Клиент',
  'ageing.colCurrent': 'Текущая',
  'ageing.col31to60': '31–60 дней',
  'ageing.col61to90': '61–90 дней',
  'ageing.colOver90': 'Более 90 дней',
  'ageing.colTotal': 'Итого',
  'ageing.totals': 'Итого',

  'statement.title': 'Выписка по клиенту',
  'statement.customer': 'Клиент',
  'statement.from': 'С',
  'statement.to': 'По',
  'statement.pickCustomer': 'Выберите клиента, чтобы увидеть его выписку.',
  'statement.loading': 'Формируем выписку…',
  'statement.denied': 'У вас нет доступа к этому.',
  'statement.failed': 'Не удалось загрузить выписку.',
  'statement.opening': 'Остаток на начало периода',
  'statement.closing': 'Остаток задолженности',
  'statement.colDate': 'Дата',
  'statement.colReference': 'Ссылка',
  'statement.colAmount': 'Сумма',
  'statement.colBalance': 'Баланс',
  'statement.kindInvoice': 'Начислено',
  'statement.kindPayment': 'Оплачено',
  'statement.empty': 'За этот период ничего не произошло.',

  'customers.creditLimit': 'Кредитный лимит',
  'customers.creditLimitNone': 'Лимит не установлен',
  'customers.creditLimitEdit': 'Изменить',
  'customers.creditLimitPlaceholder': 'Без лимита',
  'customers.creditLimitSave': 'Сохранить',
  'customers.creditLimitSaving': 'Сохранение…',
};
