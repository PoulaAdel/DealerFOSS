...
export const ar: Catalogue = {
  ...
  'stock.reconditioning': 'التجهيز للبيع',
  'stock.reconditioningNone': 'لا شيء بعد',
  'stock.bookValue': 'إجمالي المستثمر في السيارة',
  ...
  'connectors.title': 'الموصّلات',
  'connectors.loading': 'جارٍ تحميل التكاملات…',
  'connectors.denied': 'ليس لديك صلاحية الاطّلاع على تكاملات هذه الوكالة.',
  'connectors.shipped': 'بماذا ترتبط هذه النسخة',
  'connectors.none': 'لا تتضمّن هذه النسخة أي موصّلات.',
  'connectors.reads': 'يقرأ',
  'connectors.limitations': 'قيود معروفة',
  'connectors.heldBack': 'سجلات موقوفة',
  'connectors.nothingHeld': 'لا يوجد شيء موقوف.',
  'connectors.heldNote': 'وصلت هذه السجلات ولم يمكن تطبيقها. إعادة المحاولة تُشغّل السجل فعليًا؛ وإن ظلّ غير صالح يبقى هنا مع السبب الجديد. القيم الواردة لا تُعرض — فهي بيانات شخصية تخصّ أشخاصًا وتبقى على الخادم.',
  'connectors.colRecord': 'السجل',
  'connectors.colWhy': 'سبب الإيقاف',
  'connectors.colHeldSince': 'موقوف منذ',
  'connectors.colUntil': 'يُحفظ حتى',
  'connectors.colActions': 'ما الإجراء',
  'connectors.replay': 'أعد المحاولة',
  'connectors.replaying': 'جارٍ التنفيذ…',
  'connectors.dismiss': 'لن يُطبَّق أبدًا',
  'connectors.dismissAsk': 'لماذا لن يُطبَّق {id} أبدًا؟',
  'connectors.dismissed': 'تم وسم {id} بأنه لن يُطبَّق أبدًا.',
  'connectors.replayApplied': 'تم تطبيق {id} هذه المرة وغادر قائمة الانتظار.',
  'connectors.replayRefused': 'رُفض {id} مرة أخرى: {reason}',
  'connectors.certification.FixtureTested': 'مُختبَر ببيانات تجريبية',
  'connectors.certification.SandboxCertified': 'معتمد في بيئة الاختبار',
  'connectors.certification.ProductionCertified': 'معتمد للتشغيل الفعلي',
  'connectors.certification.Experimental': 'تجريبي',
  'connectors.certificationMeans.FixtureTested': 'اختبارات آلية فقط. هذا ليس وعدًا بأنه يعمل مع مزوّد حقيقي.',
  'connectors.certificationMeans.SandboxCertified': 'اجتاز بيئة اختبار المزوّد واختبارات الأعطال وإعادة التشغيل.',
  'connectors.certificationMeans.ProductionCertified': 'أكمل مقارنة موازية ومطابقة معتمدتين من الوكالة.',
  'connectors.certificationMeans.Experimental': 'مجتمعي أو تجريبي. اقرأ القيود قبل الاعتماد عليه.',
