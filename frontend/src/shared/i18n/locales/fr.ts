...
export const fr: Catalogue = {
  ...
  'stock.reconditioning': 'Remise en état',
  'stock.reconditioningNone': 'aucune pour l’instant',
  'stock.bookValue': 'Total investi dans la voiture',
  ...
  'connectors.loading': 'Chargement des intégrations…',
  'connectors.denied': 'Vous n’avez pas accès aux intégrations de cette concession.',
  'connectors.shipped': 'Ce à quoi cette version se connecte',
  'connectors.none': 'Cette version ne fournit aucun connecteur.',
  'connectors.reads': 'Lit',
  'connectors.limitations': 'Limites connues',
  'connectors.heldBack': 'Enregistrements mis de côté',
  'connectors.nothingHeld': 'Rien n’est mis de côté.',
  'connectors.heldNote': 'Ils sont arrivés et n’ont pas pu être appliqués. Réessayer exécute réellement l’enregistrement ; s’il ne convient toujours pas, il reste ici avec le nouveau motif. Les valeurs reçues ne sont pas affichées : ce sont les données personnelles de quelqu’un et elles restent sur le serveur.',
  'connectors.colRecord': 'Enregistrement',
  'connectors.colWhy': 'Motif',
  'connectors.colHeldSince': 'Mis de côté le',
  'connectors.colUntil': 'Conservé jusqu’au',
  'connectors.colActions': 'Que faire',
  'connectors.replay': 'Réessayer',
  'connectors.replaying': 'Exécution…',
  'connectors.dismiss': 'Ne s’appliquera jamais',
  'connectors.dismissAsk': 'Pourquoi {id} ne s’appliquera-t-il jamais ?',
  'connectors.dismissed': '{id} a été marqué comme ne devant jamais s’appliquer.',
  'connectors.replayApplied': '{id} s’est appliqué cette fois et a quitté la file.',
  'connectors.replayRefused': '{id} a de nouveau été refusé : {reason}',
  'connectors.certification.FixtureTested': 'Testé sur données fictives',
  'connectors.certification.SandboxCertified': 'Certifié en bac à sable',
  'connectors.certification.ProductionCertified': 'Certifié en production',
  'connectors.certification.Experimental': 'Expérimental',
  'connectors.certificationMeans.FixtureTested': 'Tests automatisés uniquement. Ce n’est pas une garantie de fonctionnement avec un vrai fournisseur.',
  'connectors.certificationMeans.SandboxCertified': 'A passé le bac à sable du fournisseur ainsi que les tests de panne et de reprise.',
  'connectors.certificationMeans.ProductionCertified': 'A terminé une comparaison en parallèle et un rapprochement approuvés par la concession.',
  'connectors.certificationMeans.Experimental': 'Communautaire ou expérimental. Lisez les limites avant de vous y fier.',
  ...
  'deals.cancelProduct': 'Annuler',
  'deals.productCancelled': 'Annulé le {date}, {refund} crédité au client',
  'deals.cancelProductTitle': 'Annuler {product}',
  'deals.cancelProductNote': "Jusqu'à {max} peut être crédité au client.",
  'deals.refundAmount': 'Montant à rembourser',
  'deals.cancelReason': 'Motif (facultatif)',
  'deals.confirmCancelProduct': 'Annuler le produit',
