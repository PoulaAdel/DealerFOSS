...
withheld from the open-source edition.
...
Contact the maintainers through the project page to discuss commercial terms.

> Note: the exact legal text of the commercial agreement and the contributor
> provenance policy (DCO/CLA) that underpins relicensing are finalized with legal
> review before external code is accepted (docs/08 §2). This document states
> intent and structure, not the final contract.
