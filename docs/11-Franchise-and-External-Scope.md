...
| Paging on every list | Platform | Build | **Part done 2026-09-11.** /leads pages properly and reports a real total; the pattern to copy is LeadPage. Customers, stock, deals, the workshop and the journal all still cap and say so |
...
| Search that runs without guessing Enter | Platform | Build | **Part done 2026-09-11.** The enquiry screen's customer search has a button now. /customers is still a form with no button, and nothing searches as you type |
